<?php
/**
 * Payment Failed - Admin Email Template
 *
 * @since 2.5.0
 */
...
<p><?php printf(esc_html__('A recurring payment has failed for %1$s (%2$s).', 'ultimate-multisite'), '{{customer_name}}', '{{customer_user_email}}'); ?></p>
