<?php
/**
 * Demo Site Expiring Email Template - Admin
 *
 * @since 2.5.0
 */
...
<p><?php echo wp_kses(sprintf(__('A demo site <b>%1$s</b> will expire in <b>%2$s</b>.', 'ultimate-multisite'), '{{site_title}}', '{{demo_time_remaining}}'), 'pre_user_description'); ?></p>

<h2><b><?php esc_html_e('Demo Site', 'ultimate-multisite'); ?></b></h2>
...
<table cellpadding="0" cellspacing="0" style="width: 100%; border-collapse: collapse;">
	...
	<tr>
		<td style="text-align: right; width: 160px; padding: 8px; background: #f9f9f9; border: 1px solid #eee;"><b><?php esc_html_e('Manage Site', 'ultimate-multisite'); ?></b></td>
		<td style="padding: 8px; background: #fff; border: 1px solid #eee;">
