<?php
/**
 * Tests for Payment_List_Admin_Page class.
 *
...
/**
 * Test class for Payment_List_Admin_Page.
 */
class Payment_List_Admin_Page_Test extends WP_UnitTestCase {

	/**
	 * @var Payment_List_Admin_Page
	 */
	private $page;
	...
	protected function setUp(): void {
		parent::setUp();
		$this->page = new Payment_List_Admin_Page();
	}
	...
	public function test_get_title(): void {
		...
		$this->assertEquals('Payments', $title);
	}
	...
	/**
	 * Test action_links has add payment link.
	 */
	public function test_action_links_add_payment(): void {
		$links = $this->page->action_links();

		$this->assertEquals('Add Payment', $links[0]['label']);
	...
	public function test_table(): void {
		...
		$this->assertInstanceOf(\WP_Ultimo\List_Tables\Payment_List_Table::class, $table);
	}
	...
	public function test_supported_panels(): void {
		...
		$this->assertEquals('wu_read_payments', $panels['network_admin_menu']);
	}
