<?php
/**
 * Tests for Product_List_Admin_Page class.
 *
...
/**
 * Test class for Product_List_Admin_Page.
 */
class Product_List_Admin_Page_Test extends WP_UnitTestCase {

	/**
	 * @var Product_List_Admin_Page
	 */
	private $page;
	...
	protected function setUp(): void {
		parent::setUp();
		$this->page = new Product_List_Admin_Page();
	}
	...
	public function test_get_title(): void {
		...
		$this->assertEquals('Products', $title);
	}
	...
	/**
	 * Test action_links has add product link.
	 */
	public function test_action_links_add_product(): void {
		$links = $this->page->action_links();

		$this->assertEquals('Add Product', $links[0]['label']);
	...
	public function test_table(): void {
		...
		$this->assertInstanceOf(\WP_Ultimo\List_Tables\Product_List_Table::class, $table);
	}
	...
	public function test_supported_panels(): void {
		...
		$this->assertEquals('wu_read_products', $panels['network_admin_menu']);
	}
