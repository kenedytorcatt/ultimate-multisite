<?php
/**
 * Tests for Signup_Field_Text class.
 *
...
/**
 * Test class for Signup_Field_Text.
 */
class Signup_Field_Text_Test extends WP_UnitTestCase {

	/**
	 * @var Signup_Field_Text
	 */
	private $field;
	...
	protected function setUp(): void {
		parent::setUp();
		$this->field = new Signup_Field_Text();
	}

	/**
	 * Test get_type returns text.
	 */
	public function test_get_type(): void {
		$this->assertEquals('text', $this->field->get_type());
	}
	...
	public function test_to_fields_array(): void {
		...
		// Set attributes on the field first
		...
		$this->assertEquals('text', $fields['test_field']['type']);
		$this->assertEquals('Test Field', $fields['test_field']['name']);
		$this->assertEquals('Enter text', $fields['test_field']['placeholder']);
	}
	...
	/**
	 * Test get_field_as_type_option returns array.
	 */
