<?php
/**
 * Tests for Signup_Field_Shortcode class.
 *
...
/**
 * Test class for Signup_Field_Shortcode.
 */
class Signup_Field_Shortcode_Test extends WP_UnitTestCase {

	/**
	 * @var Signup_Field_Shortcode
	 */
	private $field;
	...
	protected function setUp(): void {
		parent::setUp();
		$this->field = new Signup_Field_Shortcode();
	}

	/**
	 * Test get_type returns shortcode.
	 */
	public function test_get_type(): void {
		$this->assertEquals('shortcode', $this->field->get_type());
	}
	...
	public function test_get_title(): void {
		...
		$this->assertEquals('Shortcode', $title);
	}
	...
	/**
	 * Test get_fields returns array with shortcode_code.
	 */
	public function test_get_fields(): void {
		$fields = $this->field->get_fields();
		$this->assertIsArray($fields);
		$this->assertArrayHasKey('shortcode_code', $fields);
	}
	...
	public function test_to_fields_array(): void {
		...
		$this->assertIsArray($fields);
		$this->assertArrayHasKey('my_shortcode', $fields);
		$this->assertEquals('note', $fields['my_shortcode']['type']);
	}
}
